...
public class ImageRecognition : MonoBehaviour {
    ...
    IEnumerator StarbucksRoutine() {
        string url = "https://www.starbucks.com/promo/happyhour";
        ...
        HtmlNodeCollection paragraphs = doc.DocumentNode.SelectNodes("//div[contains(@class, 'region size2of3')]/p/text()");

        
        TextMesh dealText = GameObject.FindWithTag("DealText").GetComponent<TextMesh>();
